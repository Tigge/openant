...
class ShiftData(DeviceData):
    ...
    function_set_1_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_2_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_3_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_4_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_5_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_6_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_7_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    function_set_8_configuration: FunctionSetConfiguration = field(default=FunctionSetConfiguration())
    event_count: int = field(default=0)
    event_1: FunctionSetEvent = field(default=FunctionSetEvent())
    event_2: FunctionSetEvent = field(default=FunctionSetEvent())
    event_3: FunctionSetEvent = field(default=FunctionSetEvent())
    event_4: FunctionSetEvent = field(default=FunctionSetEvent())
    event_5: FunctionSetEvent = field(default=FunctionSetEvent())
    event_6: FunctionSetEvent = field(default=FunctionSetEvent())
...
class Shifting(AntPlusDevice):
    ...
    def on_data(self, data):
        ...
        if page == 0x01:
            ...
            self.data["shift"].event_1 = FunctionSetEvent(data[2] & 0x0F, (data[2] & 0x03) >> 4)
            self.data["shift"].event_2 = FunctionSetEvent(data[3] & 0x0F, (data[3] & 0x03) >> 4)
            self.data["shift"].event_3 = FunctionSetEvent(data[4] & 0x0F, (data[4] & 0x03) >> 4)
            self.data["shift"].event_4 = FunctionSetEvent(data[5] & 0x0F, (data[5] & 0x03) >> 4)
            self.data["shift"].event_5 = FunctionSetEvent(data[6] & 0x0F, (data[6] & 0x03) >> 4)
            ...
            self.data["shift"].function_set_1_configuration = FunctionSetConfiguration(data[1] & 0x02, data[1] & 0x04, data[1] & 0x08)
            self.data["shift"].function_set_2_configuration = FunctionSetConfiguration(data[2] & 0x02, data[2] & 0x04, data[2] & 0x08)
            self.data["shift"].function_set_3_configuration = FunctionSetConfiguration(data[3] & 0x02, data[3] & 0x04, data[3] & 0x08)
            self.data["shift"].function_set_4_configuration = FunctionSetConfiguration(data[4] & 0x02, data[4] & 0x04, data[4] & 0x08)
            self.data["shift"].function_set_5_configuration = FunctionSetConfiguration(data[5] & 0x02, data[5] & 0x04, data[5] & 0x08)
            self.data["shift"].function_set_6_configuration = FunctionSetConfiguration(data[6] & 0x02, data[6] & 0x04, data[6] & 0x08)
            self.data["shift"].function_set_7_configuration = FunctionSetConfiguration(data[7] & 0x02, data[7] & 0x04, data[7] & 0x08)
            self.data["shift"].function_set_8_configuration = FunctionSetConfiguration(data[8] & 0x02, data[8] & 0x04, data[8] & 0x08)
