...
class Scanner(AntPlusDevice):
    ...
    def __init__(self, node: Node, device_id=0, device_type=0, period=8070, trans_type=0):

        super().__init__(node, device_type=device_type, device_id=device_id, period=period, trans_type=trans_type)
